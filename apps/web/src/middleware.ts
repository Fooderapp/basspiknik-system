...
const PUBLIC_PATHS = ["/", "/events", "/artists", "/menu", "/sign-in", "/sign-up", "/auth", "/venue", "/api/webhooks", "/api/wallet", "/api/google-wallet", "/api/terminal", "/api/seller", "/api/orders", "/api/credits", "/api/tasks", "/api/promos", "/api/qr", "/r", "/widget", "/adatvedelem", "/aszf", "/impresszum"];
