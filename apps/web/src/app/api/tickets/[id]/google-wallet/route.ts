...
export async function GET(
  ...
  return new NextResponse(
    `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Google Wallet</title>
    ...
    <body>
      ...
      <h1>Google Wallet coming soon</h1>
