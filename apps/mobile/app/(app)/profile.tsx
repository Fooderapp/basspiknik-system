...
export default function ProfileScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Wallet-style holographic entry pass — pinned to the top */}
      {walletToken && (
        <View className="mb-6">
          <TiltCard maxTilt={11} radius={28}>
            <View
              style={{
                borderRadius: 28,
                padding: 22,
            ...
            >
              ...
              {/* QR — rendered locally in black */}
              <View className="items-center">
                <View className="bg-white p-3.5 rounded-2xl">
                  <QRCode value={walletToken} size={188} color="#000000" backgroundColor="#ffffff" />
                </View>
              </View>
