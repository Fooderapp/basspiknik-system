-- Migration 020: Fix sell_tickets_cash — tickets were missing tier column
--
-- Migrations 018 and 019 never included `tier` in the tickets INSERT,
-- so every cash/tap-to-pay ticket landed with the default tier 'GENERAL'.
-- Also adds holder_email so the confirmation email can address the buyer.
